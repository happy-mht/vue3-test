<template>
  <div class="login-container">
    <el-form v-if="isUseAAPage" ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
...
export default {
  ...
  mounted() {
    if (process.env.NODE_ENV === 'development') {
      this.isUseAAPage = true
    } else {
      if (document.cookie.indexOf('ee_cookie_series') == -1) {
